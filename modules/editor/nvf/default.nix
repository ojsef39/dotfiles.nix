  ...
  in {
    ...
    programs.nvf = {
      ...
      settings.vim = lib.mkMerge [
        ...
        (import ./_parts/options.nix {
          lib = extendedLib;
          inherit vars;
        })
        (import ./_parts/autocmds.nix {
          lib = extendedLib;
          inherit vars;
        })
        (import ./_parts/keymaps.nix {
          lib = extendedLib;
          inherit vars;
        })
        (import ./_parts/languages.nix {
          inherit pkgs;
          lib = extendedLib;
          inherit vars;
        })
        (import ./_parts/plugins.nix {
          inherit pkgs;
          lib = extendedLib;
          inherit vars;
        })
        (import ./_parts/plugins-custom.nix {
          inherit pkgs;
          lib = extendedLib;
          inherit vars;
        })
        (import ./_parts/extra-config.nix {
          lib = extendedLib;
          inherit vars;
        })
      ];
