    ...
    conform-nvim = {
      ...
      setupOpts = {
        ...
        formatters_by_ft = {
          ...
          scss = ["prettier"];
          swift = lib.optionals pkgs.stdenv.hostPlatform.isDarwin ["swift-format"];
          vue = ["prettier"];
          yaml = ["prettier"];
        ...
        formatters = {
          ...
          "swift-format" = {
            command = "${lib.optionalString pkgs.stdenv.hostPlatform.isDarwin "${pkgs.swift-format}/bin/"}swift-format";
            stdin = true;
            args = [
              "format"
              "--assume-filename"
  ...
  diagnostics = {
    nvim-lint = {
      ...
      linters = {
        ...
        "swift-format" = {
          cmd = "${lib.optionalString pkgs.stdenv.hostPlatform.isDarwin "${pkgs.swift-format}/bin/"}swift-format";
          args = [
            "lint"
            "--strict"
          ];
